...
describe("Event Service", () => {
    ...
    let fakeEvents = [
        ...
        new Event(new Date('2020-04-01T09:00:00'), new Date('2020-04-01T07:00:00'), "Unit test against", "Campus Numerique", "This is an hello world.."),
    ];
    ...
    test('getFirstEvent shall return the latest', async  () => {
        let eventService = new EventService(new EventRepository());
